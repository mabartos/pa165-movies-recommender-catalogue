...
public class SimpleRecommendationServiceImpl implements RecommendationService{

    private final MovieDao movieDao;
    private final PersonDao personDao;

    @Autowired
    public SimpleRecommendationServiceImpl(MovieDao movieDao, PersonDao personDao) {
